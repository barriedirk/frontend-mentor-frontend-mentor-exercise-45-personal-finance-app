...
const CopilotAuthorEmailRegex = /^(?:\d+\+)?copilot@users\.noreply\.github\.com$/;
class DefaultChangelogRenderer {
    ...
    isAiAgentAuthor(author) {
        const email = (author.email || '').trim().toLowerCase();
        return (AiAgentAuthorEmails.has(email) || CopilotAuthorEmailRegex.test(email));
    }
    formatName(name = '') {
        return name
            .split(' ')
