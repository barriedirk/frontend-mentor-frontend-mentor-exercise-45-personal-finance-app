...
async function promptForValues(opts, schema, projectsConfigurations) {
    try {
        ...
        for (const question of getPromptsForSchema(opts, schema, projectsConfigurations)) {
...
async function askSchemaQuestion(question) {
    ...
    switch (question.type) {
        ...
        case 'numeral': {
            ...
            const answer = await (0, prompt_helpers_1.textPrompt)({
                message: question.message,
                initialValue: question.initial === undefined ? undefined : String(question.initial),
