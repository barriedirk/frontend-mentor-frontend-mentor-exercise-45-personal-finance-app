...
function respondToClient(socket, response, description) {
    return new Promise(async (res) => {
        ...
        (0, consume_messages_from_socket_1.writeMessage)(socket, response, (err) => {
            if (err) {
 ...
 */
async function respondWithError(socket, description, error) {
    ...
    await respondToClient(socket, Buffer.from((0, socket_utils_1.serializeResult)(error, null, null), 'utf8'), null);
}
