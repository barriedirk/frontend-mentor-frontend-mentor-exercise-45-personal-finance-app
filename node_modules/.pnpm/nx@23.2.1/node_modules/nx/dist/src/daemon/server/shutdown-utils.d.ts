...
export declare function respondToClient(socket: Socket, response: Buffer, description: string): Promise<unknown>;
/**
 ...
 */
export declare function respondWithError(socket: Socket, description: string, error: Error): Promise<void>;
