...
exports.resolveTsNodeEsmCompilerOptions = resolveTsNodeEsmCompilerOptions;
...
function ensureEsmLoaderRegistered(opts) {
    ...
    if (!swcEsm) {
        ...
        module.register('data:text/javascript,' +
            encodeURIComponent(`process.env.TS_NODE_COMPILER_OPTIONS = ${JSON.stringify(resolveTsNodeEsmCompilerOptions(process.env.TS_NODE_COMPILER_OPTIONS))};`));
    }
 ...
 */
function resolveTsNodeEsmCompilerOptions(raw) {
    if (raw === undefined) {
