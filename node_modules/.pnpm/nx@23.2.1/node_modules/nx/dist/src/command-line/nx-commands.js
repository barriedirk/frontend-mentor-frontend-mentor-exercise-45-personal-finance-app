...
const command_object_25 = require("./nx-cloud/start-nx-agents/command-object");
...
const command_object_36 = require("./completion/command-object");
...
exports.commandsObject = yargs
    ...
    .command(command_object_25.yargsStartNxAgentsCommand)
    ...
    .command(command_object_36.yargsCompletionCommand)
