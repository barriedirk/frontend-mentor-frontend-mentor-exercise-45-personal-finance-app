...
async function addNxToNest(options, packageJson) {
    ...
    if (options.interactive && scripts.length > 0) {
        ...
        for (const scriptName of cacheableOperations) {
            scriptOutputs[scriptName] = await (0, prompt_helpers_1.textPrompt)({
...
function addNestPluginToPackageJson(repoRoot) {
    ...
    (0, format_1.recordInitWrite)(path);
}
...
`, 'utf8');
        (0, format_1.recordInitWrite)(jestPresetPath);
        return true;
    }
    return false;
}
