        ...
        for (const releaseGroup of releaseGraph.releaseGroups) {
            ...
            if (releaseGroup.projectsRelationship === 'independent') {
                ...
                if (releaseGroup.resolvedVersionPlans) {
                    ...
                    const fromSHA = await getCachedFromSHA(groupCacheKey, releaseGroup.releaseTag.pattern, {
                        releaseGroupName: releaseGroup.name,
                    }, workspacePreid ?? projectsPreid?.[Object.keys(projectsPreid)[0]], releaseGroup.releaseTag.checkAllBranchesWhen, releaseGroup.releaseTag.requireSemver, releaseGroup.releaseTag.strictPreid);
                    if (!fromSHA) {
